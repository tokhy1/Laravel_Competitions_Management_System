...
@section('modal-body')
    <form method="POST" action="/dashboard/add-individual-event-score">
        @csrf
        <div class="mb-3">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-outline-danger"
                            href="/dashboard/delete-individual-event-score/{{ $event_score->id }}">Delete</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Update Individual Event Score</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="POST"
                        action="{{ isset($event_score) ? '/dashboard/update-individual-event-score/' . $event_score->id : '/dashboard/update-team-individual-score/' }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <label class="form-label">Event ID</label>
